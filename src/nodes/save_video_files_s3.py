...
class SaveVideoFilesS3:
    ...
    def save_video_files(self, filenames, filename_prefix="VideoFiles", full_filename="", auto_content_type=True):
        ...
        for path in local_files:
            ...
            if full_filename:
                file = full_filename
                # If the filename doesn't have an extension, add the original extension
            ...
            file_path = S3_INSTANCE.upload_file(path, s3_path, auto_content_type)
